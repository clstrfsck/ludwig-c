...
inline constexpr std::string_view MSG_COMPILER_CODE_OVERFLOW{
    "Compiler code overflow, too many compiled spans."
};
inline constexpr std::string_view MSG_COPYRIGHT_AND_LOADING_FILE{
    "Copyright (C) 1981, 1987,  University of Adelaide."
};
...
inline constexpr std::string_view MSG_ERROR_OPENING_KEYS_FILE{
    "Error opening keys definitions file."
};
...
inline constexpr std::string_view MSG_FRAME_OF_THAT_NAME_EXISTS{
    "Frame of that Name Already Exists."
};
...
inline constexpr std::string_view MSG_LEFT_MARGIN_GE_RIGHT{
    "Specified Left Margin is not less than Right Margin."
};
...
inline constexpr std::string_view MSG_NO_ROOM_ON_LINE{
    "Operation would cause a line to become too long."
};
...
inline constexpr std::string_view MSG_NONPRINTABLE_INTRODUCER{
    "Command Introducer is not printable"
};
inline constexpr std::string_view MSG_NOT_ENOUGH_INPUT_LEFT{
    "Not enough input left to satisfy request."
};
...
inline constexpr std::string_view MSG_NOT_WHILE_EDITING_CMD{
    "Operation not allowed while editing frame COMMAND."
};
inline constexpr std::string_view MSG_NOT_ALLOWED_IN_INSERT_MODE{
    "Command not allowed in insert mode."
};
...
inline constexpr std::string_view MSG_SPAN_MUST_BE_ONE_LINE{
    "A span used as a trailing parameter for this command must be one line."
};
...
inline constexpr std::string_view MSG_ENQUIRY_MUST_BE_ONE_LINE{
    "An enquiry item must be on one line."
};
...
inline constexpr std::string_view MSG_SYNTAX_ERROR_IN_PARAM_CMD{
    "Syntax error in parameter command."
};
inline constexpr std::string_view MSG_TOP_MARGIN_LSS_BOTTOM{
    "Top margin must be less than or equal to bottom margin."
};
inline constexpr std::string_view MSG_TPAR_TOO_DEEP{
    "Trailing parameter translation has gone too deep."
};
inline constexpr std::string_view MSG_UNKNOWN_OPTION{"Not a valid option."};
inline constexpr std::string_view MSG_PAT_NO_MATCHING_DELIM{
    "Pattern - No matching delimiter in pattern."
};
inline constexpr std::string_view MSG_PAT_ILLEGAL_PARAMETER{
    "Pattern - Illegal parameter in pattern."
};
inline constexpr std::string_view MSG_PAT_ILLEGAL_MARK_NUMBER{
    "Pattern - Illegal mark number in pattern."
};
...
inline constexpr std::string_view MSG_INCONSISTENT_QUALIFIER{
    "Use of this qualifier is inconsistent with file operation"
};
...
inline constexpr std::string_view DBG_BADFILE{
    "FILE and FILESYS definition of file_object disagree."
};
...
inline constexpr std::string_view DBG_NEEDED_FRAME_NOT_FOUND{
    "Frame C or OOPS is not in the span list"
};
