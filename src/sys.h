...
[[nodiscard]] bool sys_suspend();
[[nodiscard]] bool sys_shell();
[[nodiscard]] bool sys_istty();
[[nodiscard]] bool sys_getenv(const std::string &environ, std::string &result);
...
// Filesystem access
[[nodiscard]] bool sys_expand_filename(std::string &filename);
...
[[nodiscard]] bool sys_file_exists(const std::string &filename);
[[nodiscard]] bool sys_file_writeable(const std::string &filename);
...
[[nodiscard]] bool sys_read_filename(const std::string &memory, std::string &filename);
